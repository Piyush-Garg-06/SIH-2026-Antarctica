...
console.log('Connecting to Station Broker ([::1]:1883)...');
const client1883 = mqtt.connect('mqtt://[::1]:1883');
...
console.log('Connecting to Mainland Broker ([::1]:1884)...');
const client1884 = mqtt.connect('mqtt://[::1]:1884');
